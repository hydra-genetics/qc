...
Creates group file defining trio relationships (father-mother-proband) from sample sheet for somalier's trio analysis. Requires `trio`, `father`, and `mother` columns in `samples.tsv`.
